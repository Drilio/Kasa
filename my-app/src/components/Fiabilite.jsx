...
export default function Fiabilite() {
    ...
    function oppener() {
        if (isOpen === false) {
            setIsOpen(true);
            document.getElementById('chevron-fiabilite').setAttribute('class', 'fa-solid fa-chevron-up')
        } else {
            setIsOpen(false);
            document.getElementById('chevron-fiabilite').setAttribute('class', 'fa-solid fa-chevron-down')
        };
